...
//Senden eines TMCL-Befehls in binärer Form.
//z.B.  SendCmd(ComHandle, 1, TMCL_MVP, MVP_ABS, 1, 50000);  entsricht MVP ABS, 1, 50000 für Modul mit Adresse 1.
//Parameter: Handle: Handle der RS232-Schnittstelle (wird von OpenRS232 zurückgegeben).
...
//           Value:   Wert, (z.B. Position oder Geschwindigkeit, abhängig vom Befehl).
...
//Einlesen des vom Modul zurückgebenen Datenpaketes.
//Parameter: Handle: Handle der seriellen Schnittstelle (wird von OpenRS232 zrucükgegeben)
//           Address: Die Adresse des Moduls wird hier abgelegt
//           Status: Der Status des Moduls wird hier abgelegt (z.B. 100 für alles in Ordnung).
//           Value: Der Rückgabewert eines Abfragebefehls wird hier abgelegt.
//Rückgabewert: TMCL_RESULT_OK: Daten wurden erfolgreich eingelesen
//              TMCL_RESULT_NOT_READY: Es konnten keine Daten eingelesen werden.
//              TMCL_RESULT_CHECKSUM_ERROR: Prüfumme falsch.
